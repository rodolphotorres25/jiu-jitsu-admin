...
class ErrorBoundary extends Component<Props, State> {
  // Fix: Replaced the constructor with a state class property for cleaner state initialization
  // and to resolve type inference issues that were causing errors.
